...
:: old version: %s/^.* Image \(.* was successfully uploaded\.$\)\@=/del "/ge | %s/.* Couldn't upload \(.*: image already exists here\.\)\@=/del "/ge | %s/: image already exists here\.$/"/ge | %s/ was successfully uploaded\.$/"/ge | %s/.* Couldn't upload \(.*: image too big? too small? corrupted?\.\)\@=/move "/ge | %s/: image too big? too small? corrupted?\./" upload_failure_dimensions/ge | %s/.* Couldn't upload \(.*: undefined\.$\)\@=/move "/ge | %s/: undefined\.$/" upload_failure_undefined/ge | g/^$/d
